...
# Changes Copyright (C) 2021 - 2023 Perl-Services.de, https://perl-services.de
# --
...
package Kernel::GenericInterface::Operation::Ticket::TicketGetFiltered;
...
# ---
            ...
            my $TicketFilter = $ConfigObject->Get('GIExtension::TicketFilter') || {};

            for my $Filter ( sort keys %{ $TicketFilter } ) {
                my $Module = $TicketFilter->{$Filter}->{Module};

                next FILTER if !$Module;
